...
<html lang="en">
    <head>
        ...
        <title>Karangtaruna - Events</title>
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="<?= base_url() ?>">Karangtarun</a>
        ...
        <header class="masthead">
            <div class="container d-flex h-100 align-items-center">
                <div class="mx-auto text-center">
                    <h1 class="mx-auto my-0 text-uppercase">Karangtaruna</h1>
                    <h2 class="text-white-50 mx-auto mt-2 mb-5">Illato, Yang Muda Yang Berkarya</h2>
                </div>
            </div>
        </header>
        <!-- Projects-->
        ...
        <!-- Footer-->
        <footer class="footer bg-black small text-center text-white-50"><div class="container">Copyright © <a href="https://aa43000.github.io">SIS-Karangtaruna</a> 2023</div></footer>
        <!-- Bootstrap core JS-->
