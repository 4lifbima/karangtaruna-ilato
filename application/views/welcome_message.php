...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="row justify-content-center">
        <div class="col-xl-10 d-flex align-items-center justify-content-end">
          ...
          <h1 class="logo mr-auto"><a href="<?= base_url() ?>">Karangtaruna</a></h1>
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><a href="https://aa43000.github.io/">SIS-Karangtaruna</a></strong>. All Rights Reserved
      </div>
    </div>
  </footer><!-- End Footer -->
